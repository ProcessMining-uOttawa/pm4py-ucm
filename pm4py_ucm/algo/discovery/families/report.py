...
<header>
  ...
  pm4py-ucm · self-contained (works offline)</div>
  <div class="chips" id="chips"></div>
</header>
<nav id="nav"></nav>
<main id="main"></main>
<div id="lightbox" onclick="this.style.display='none'"></div>
<footer>pm4py-ucm family report — sortable columns (click a header),
heat-mapped values, and a pair comparison under <b>Compare</b>. Open
the file several times to compare more than one pair side by side.</footer>
<script>
const DATA = __DATA__;
