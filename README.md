...
[![Streamlit V4](https://img.shields.io/badge/Streamlit-V4%20workspace-FF4B4B?logo=streamlit&logoColor=white)](https://pm4py-ucm.streamlit.app/)
...
- [`web/streamlit_app_v4.py`](web/streamlit_app_v4.py) — the **V4 web app** (model, scenarios, model families, statistics reports, **and Dashboards**), hosted at https://pm4py-ucm.streamlit.app/ — click, don't code: upload an XES/CSV, tune the miner, download the result. (The **V2** scenarios app stays at https://pm4py-ucm-scenarios.streamlit.app/.)
...
The **Dashboards** view — V4's addition to the four above — builds widgets
...
streamlit run web/streamlit_app_v4.py    # V4 (latest — deployed)
