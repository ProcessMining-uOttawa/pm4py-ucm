...
This shim keeps the first Streamlit Cloud deployment
...
configuration; ``streamlit_app_v2.py`` does the same for the second
deployment. The V1 model-only app was retired when V3 became a strict
superset — its last version remains in git history (up to v0.5.1).
"""
