...
.. DEPRECATED — superseded by V6 ......................................
   ...
   and a second deployment, ``pm4py-ucm-scenarios.streamlit.app`` (since
   deleted), served it so it kept matching what the reviewers saw. That paper has
...
Helper code is intentionally inlined rather than shared with the other
app files — keeps each a self-contained one-file app whose deployment
cannot be regressed by refactors elsewhere.
"""
