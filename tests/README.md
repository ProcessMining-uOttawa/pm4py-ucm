...
**1057 tests** across **33 modules**, grouped by area below. Counts are pytest-collected items (parametrised cases counted individually), so they match `pytest` exactly.
...
| | _Object model & jUCMNav I/O subtotal_ | | **66** |
...
| **Other** | [`test_scenario_traversal.py`](test_scenario_traversal.py) | Offline simulation of jUCMNav's scenario traversal. | 23 |
| | **Total** | | **1057** |
