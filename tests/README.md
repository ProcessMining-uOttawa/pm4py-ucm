...
**849 tests** across **25 modules**, grouped by area below. Counts are pytest-collected items (parametrised cases counted individually), so they match `pytest` exactly.
...
| | _Sessions (save / share / resume) subtotal_ | | **19** |
